...
On the underside of the case (fig. \ref{fig:TrinityTopBottom}) there are a rotating ring for removing the ball and cleaning the mouse, a label with technical data, and four low-friction pads. On the top side are three fairly large buttons extending onto the front of the mouse case, as well as 16 miniature round buttons that serve as a numeric keypad and function keys. On the sides of the case are two more rectangular buttons. Additionally, on the front of the case is a ribbed sleeve that protects the cable from mechanical damage where it exits the case, as well as two LEDs surrounding it.
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.4]{1994_mariqua_mouse/size_30.jpg}
