...
Thinking Mouse was released in 1995 by the American company Kensington Computer Products Group as part of a line of several similarly shaped mice \cite{kensingtonfamily}. The Kensington Thinking Mouse, the top model in the line, was released for PCs (fig. \ref{thinkingmousepic}) and for Apple computers with an ADB interface \cite{thinkingmouse}, like the company's other mice and trackballs.
