...
\input{theory_mech}
\input{theory_track}
\input{1983_apple_lisa_mouse}
\input{1983_hawley_mark_ii}
\input{1986_commodore_c300_mouse}
\input{1986_american_mouse}
\input{1986_nec_crystal_mouse}
\input{1986_honeywell_microlynx_trackball}
\input{1987_ibm_ps2_mouse}
\input{1987_microspeed_fasttrap}
\input{1989_prohance_powermouse}
\input{1989_kraft_trackball}
\input{1990_kraft_toptrack}
\input{1991_microspeed_pc-track}
\input{1992_ibm_convertible}
\input{1992_lotus_mouse}
\input{1993_colani_trackball}
\input{1993_easy_options_trackball}
\input{1994_memorex_trackball}
\input{1995_pro_agio_scroll_mouse}
\input{1995_logitech_trackman}
\input{1996_kensington_expert_trackball_5}
\input{1997_fellowes_trackball}
\input{1998_apple_puck}
\input{1999_protrack_60i}
\newpage
