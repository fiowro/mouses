...
Removing the clock from its case reveals that it was apparently originally intended for sale as a standalone device. At least, it is equipped with a folding stand for placing it on a tabletop (fig. \ref{fig:AeroClock}). The time can be adjusted in a manner standard for the 1970s electronic watch, with two buttons on its front panel.
