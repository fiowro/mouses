...
Both the joystick and mouse were meant to be connected to one of two ports located on the sides of the keyboard.
The real manufacturer of the joystick, as well as the mouse, was the Japanese company Alps -- the manufacturer of the first Japanese mouse, MZ-1X10, introduced to the Japanese market one year earlier.
...
The joystick is a miniature device (fig. \ref{fig:MindsetJoystickSize}), so its creators most likely did not rely on one hand usage too much.
...
The buttons are located on the sides of the body, which isn't the best ergonomic solution for one-handed operation, as shown in the fig. \ref{fig:MindsetJoystickHand}, as the miniature body will shift at the stick or buttons presses. The user was likely intended to hold the joystick in the palm of one hand and control the ystick with the fingers of the other.
