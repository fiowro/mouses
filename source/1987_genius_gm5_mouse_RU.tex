...
По сильному визуальному сходству можно предположить, что форма корпуса была позаимствована у Manager Mouse --- мыши, выпущенной двумя годами ранее компанией The Torrington Company в Коннектикуте.
...
\bibitem {armadale} Container -- Genius Mouse for Commodore 64 Computer | Collections WA \url{https://collectionswa.net.au/items/05f909a7-5ccf-4edb-9cd8-b610b0eddd9d}
...
\bibitem {atari} Genius GM 5 -- Postimages \url{https://postimg.cc/k2n5PmTh}
\end{thebibliography}
\end{document}
