...
Джойстик Dave Brown Dual (рис. \ref{fig:DaveBrownJoystickPic}) --- это двухосевой джойстик, копирующий внешний вид и конструктивные особености пультов от радиоуправляемых моделей самолётов 80-х годов. Однако, вместо использования с радиоуправлением, джойстик является проводным, созданным специально для программы-авиасимулятора Dave Brown RC Flight Simulator, написанной энтузиастом авиамоделирования Джоном Калиндом \cite{Kallend1, Kallend2}. Этот авиасимулятор был доступен на компьютерах Apple II и Commodore 64 в первой половине 1980-х годов, и еще дольше --- на IBM-совместимых компьютерах (встречаются коробочные версии Dave Brown R/C Simulator 1995 года, укомплектованные данным джойстиком). В рамках симуляции джойстик позволяет контролировать параметры полёта, включая крен, тангаж, скорость и высоту, аналогично тому, как это реализовано в радиоуправляемых моделях. Согласно документации, джойстик имел собственное имя, <<Transmitter>> (от англ. <<передатчик>>) \cite{Joystick1}.

\begin{figure}[h]
   \centering
    \includegraphics[scale=0.75]{1984_dave_brown_dual_joystick/pic_30.jpg}
    \caption{Джойстик Dave Brown Dual}
    \label{fig:DaveBrownJoystickPic}
\end{figure}

Как уже упоминалось, корпус устройства копирует вид и компоновку пультов управления авиамоделями: он металлический и выполнен в виде габаритного прямоугольного блока с двумя независимыми стиками, что видно на рис. \ref{fig:DaveBrownJoystickTopAndBottom}. Нижняя сторона корпуса --- абсолютно плоская, лишена каких-либо элементов, в том числе ножек. На верхней стороне можно видеть две рукоятки, каждая со своей парой триммеров, предназначенных для механической регулировки центрального положения по обеим осям, и две красные кнопки тумблерного типа с фиксацией. Еще одна кнопка находится на дальней от пользвоателя стороне корпуса, и там же присутствуют два кабеля, подключаемые к компьютеру (один кабель соответствует левому стику, другой --- правому).
...
Джойстик и весь механический блок являются стандартным компонентом: их можно найти на некоторых компактных аналоговых джойстиках других компаний того времени, включая самый первый джойстик для Apple II, разработанный Джефом Раскином, а затем выпускавшийся под брендом A2D Company. Джойстики довольно удобно использовать, держа их пальцами, в то время как ладонь опирается на корпус (рис. \ref{fig:DaveBrownJoystickHand}), чего нельзя сказать о миниатюрных кнопках.
...
Симулятор полёта R/C Flight Simulator \cite{Joystick2} предназначен для моделирования управления радиоуправляемыми самолётами на экранах 8-битных домашних компьютеров, таких как Apple II и Commodore 64 \cite{Joystick2}.
