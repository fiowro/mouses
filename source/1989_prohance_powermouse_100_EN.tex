...
The Prohance PowerMouse 100's size (figure \ref{fig:ProhanceSize}) doesn't give it the best ergonomics; however, this is not the only problem of this mouse. An important drawback is the size of the buttons: both the two main buttons and the additional Prohance keys have too small area. 
...
\bibitem{box} Prohance PowerMouse 100 [the box] \url{https://raw.githubusercontent.com/fiowro/mouses/main/source/OCR/prohance_powermouse_100_box.pdf}
\bibitem{manual} Prohance PowerMouse and PowerTrack User's guide \url{https://raw.githubusercontent.com/fiowro/mouses/main/source/OCR/prohance_powermouse_powertrack_manual.pdf}
