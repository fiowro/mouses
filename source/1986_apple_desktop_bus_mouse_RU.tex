...
Это была первая мышь, официально выполненная в рамках дизайн-языка <<Snow White>>, разработанного по заказу Apple в Frog Design -- компании промышленного дизайнера Хартмута Эсслингера \cite{apple1, apple2}. 
...
Корпус мыши Apple Desktop Mouse прямоуголен в основании, имеет клиновидный продольный профиль и выглядит достаточно неестественно (рис. \ref{fig:top}). 
...
На нижней стороне корпуса находится поворотное кольцо контрастного черного цвета (в некоторых других модификациях Apple Desktop Mouse оно выполнялось из пластика того же цвета, что и корпус), 
